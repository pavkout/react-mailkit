...
Currently `mjml` and `react-mailkit` libraries are meant to be run inside a node.

## Example project

You can find an example project here
[https://github.com/@react-mailkit/example](https://github.com/react-mailkit-example)
